...
package org.corvus.device.DeviceSettings;
...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (org.corvus.device.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, org.corvus.device.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
